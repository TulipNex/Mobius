module.exports = {
     ...
     */
    xpRange(level, multiplier = global.multiplier || 36) { // Default diubah ke 36
     ...
     * @param {Number} multiplier 
     */
    findLevel(xp, multiplier = global.multiplier || 36) { // Default diubah ke 36
     ...
     * @param {Number} multiplier 
     */
    canLevelUp(level, xp, multiplier = global.multiplier || 36) { // Default diubah ke 36
